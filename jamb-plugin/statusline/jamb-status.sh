#!/usr/bin/env bash
# Jamb statusline — animated, right-aligned multi-line companion
#
# Art is pre-rendered by jamb/art_cache.py into ~/.claude/jamb/art_cache.json.
...
ART_CACHE="$HOME/.claude/jamb/art_cache.json"
